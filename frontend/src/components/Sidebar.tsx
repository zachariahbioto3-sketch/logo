  ...
  return (
    <>
      <button
        ...
        className="md:hidden fixed top-4 left-4 z-40 bg-[var(--nicole-cream)] border border-[var(--nicole-border)] rounded-lg p-2 shadow-sm"
      >
      ...
      >
        <div className="p-4 space-y-1">
          ...
          <button
            ...
            className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium hover:bg-[var(--nicole-cream)] transition-colors"
          >
            <PlusIcon className="w-4 h-4" /> New chat
          </button>
          <button
            onClick={() => setSearchOpen(true)}
            className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-[var(--nicole-text-muted)] hover:bg-[var(--nicole-cream)] transition-colors"
          >
          ...
          <Link
            ...
            className={`w-full flex items-center justify-between px-3 py-2 rounded-lg text-sm transition-colors ${
              pathname === "/usage" ? "bg-[var(--nicole-cream)] font-medium" : "text-[var(--nicole-text-muted)] hover:bg-[var(--nicole-cream)]"
            }`}
          >
          ...
          <Link
            ...
            className={`w-full flex items-center gap-2 px-3 py-2 rounded-lg text-sm transition-colors ${
              pathname === "/customize" ? "bg-[var(--nicole-cream)] font-medium" : "text-[var(--nicole-text-muted)] hover:bg-[var(--nicole-cream)]"
            }`}
          >
        ...
        <nav className="px-4 space-y-1 pb-4 border-b border-[var(--nicole-border)]">
          {navItems.map(({ label, href, Icon }) => (
            <Link
              ...
              href={href}
              className={`w-full flex items-center gap-2 px-3 py-2 rounded-lg text-sm transition-colors ${
                pathname === href ? "bg-[var(--nicole-cream)] font-medium" : "hover:bg-[var(--nicole-cream)]"
              }`}
            >
          ...
          <div className="space-y-1">
            ...
            {recents.map((r) => (
              <Link
                key={r.id}
                href={`/chat/${r.id}`}
                className={`group flex items-center justify-between px-3 py-2 rounded-lg hover:bg-[var(--nicole-cream)] transition-colors ${
                  pathname === `/chat/${r.id}` ? "bg-[var(--nicole-cream)]" : ""
                }`}
              >
